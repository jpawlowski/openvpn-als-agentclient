 ...
 */
public class SwingPortMonitorWindow extends JInternalFrame {
     ...
     * @param vpnClient
     */
    public SwingPortMonitorWindow(Agent vpnClient) {
        ...
        stopButton.addActionListener(new ActionListener() {
           ...
           public void actionPerformed(ActionEvent evt) {
               Option opt = OptionDialog.prompt(SwingPortMonitorWindow.this, OptionDialog.WARNING, Messages.getString("PortMonitor.close.title"), //$NON-NLS-1$
